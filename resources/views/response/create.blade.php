...
@section('title', 'Create new API response')
            ...
            <form action="{{ route('response.store') }}" method="POST">
                <div class="row">
                    ...
                    <div class="mb-3 col-lg-4 col-sm-12">
                        ...
                        <br>
                        <input id="code" type="number" class="form-control" placeholder="Default: 200" name="code" value="{{ old('code') }}">
                    </div>
                    <div class="mb-3 col-lg-4 col-sm-12">
                        <label class="mb-2" for="delay">Delay</label>
                        <br>
                        <input id="delay" type="number" class="form-control" placeholder="in milliseconds" name="delay" value="{{ old('delay') }}">
                    </div>
                </div>
